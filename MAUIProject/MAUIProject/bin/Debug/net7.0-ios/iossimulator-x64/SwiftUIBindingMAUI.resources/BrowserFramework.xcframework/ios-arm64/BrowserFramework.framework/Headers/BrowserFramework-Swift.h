...
SWIFT_CLASS_NAMED("BookmarkEntity")
...
@interface BookmarkEntity (SWIFT_EXTENSION(BrowserFramework))
@property (nonatomic) int64_t createdDate;
...
SWIFT_CLASS_NAMED("BrowserViewManager")
...
SWIFT_CLASS("_TtC16BrowserFramework11ChangeTools")
@interface ChangeTools : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSData;

SWIFT_CLASS_NAMED("DownloadAppManager")
@interface DownloadAppManager : NSObject
@property (nonatomic, strong) UIView * _Nullable downloadView;
- (nonnull instancetype)initWithData:(NSData * _Nonnull)data downloadStatus:(NSInteger)downloadStatus OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS_NAMED("HistoryEntity")
...
@interface HistoryEntity (SWIFT_EXTENSION(BrowserFramework))
@property (nonatomic) int64_t createdDate;
@property (nonatomic, copy) NSUUID * _Nullable id;
@property (nonatomic, copy) NSString * _Nullable imageName;
@property (nonatomic, copy) NSString * _Nullable link;
...
SWIFT_CLASS_NAMED("HotSearchEntity")
@interface HotSearchEntity : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end



@interface HotSearchEntity (SWIFT_EXTENSION(BrowserFramework))
@property (nonatomic, copy) NSUUID * _Nullable id;
...
SWIFT_CLASS("_TtC16BrowserFramework15LeadReplyHandle")
@interface LeadReplyHandle : NSObject <WKScriptMessageHandlerWithReply>
...
SWIFT_CLASS("_TtC16BrowserFramework16LeadScriptHandle")
@interface LeadScriptHandle : NSObject <WKScriptMessageHandler>
...
SWIFT_CLASS("_TtC16BrowserFramework16WebViewViewModel")
...
@interface WebViewViewModel (SWIFT_EXTENSION(BrowserFramework)) <WKUIDelegate>
@end


@interface WebViewViewModel (SWIFT_EXTENSION(BrowserFramework)) <WKScriptMessageHandler>
- (void)userContentController:(WKUserContentController * _Nonnull)userContentController didReceiveScriptMessage:(WKScriptMessage * _Nonnull)message;
@end


@interface WebViewViewModel (SWIFT_EXTENSION(BrowserFramework)) <WKScriptMessageHandlerWithReply>
- (void)userContentController:(WKUserContentController * _Nonnull)userContentController didReceiveScriptMessage:(WKScriptMessage * _Nonnull)message replyHandler:(void (^ _Nonnull)(id _Nullable, NSString * _Nullable))replyHandler;
@end
...
@interface WebViewViewModel (SWIFT_EXTENSION(BrowserFramework)) <WKNavigationDelegate>
