...
@class MAUIProject_Platforms_iOS_FirstViewController;
@class MAUIProject_AppDelegate_MyViewController;
@class Microsoft_Maui_MauiUIApplicationDelegate;
@class AppDelegate;
@class PlatformGraphicsView;
@class BrowserManager;
@class DownloadAppManager;
...
@interface MAUIProject_Platforms_iOS_FirstViewController : UIViewController {
}
	-(void) release;
	-(id) retain;
...
@interface MAUIProject_AppDelegate_MyViewController : UIViewController {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
...
@interface BrowserManager : NSObject {
	...
	-(void) addNewWkWebViewWithWebView:(WKWebView *)p0;
	-(void) clickAddNewHomePageActionWithCallback:(void (^)())p0;
	-(void) clickAppActionWithCallback:(void (^)(void *))p0;
	-(void) fetchHomeDataWithParam:(NSArray *)p0 webViewList:(NSArray *)p1;
	-(void) showWebViewListDataWithList:(NSArray *)p0;
	-(UIView *) swiftView;
	-(void) setSwiftView:(UIView *)p0;
	-(void *) webViewCount;
	-(void) setWebViewCount:(void *)p0;
	-(id) init;
@end

@interface DownloadAppManager : NSObject {
}
	-(void) clickDownloadActionWithCallback:(void (^)(void *))p0;
	-(void) onBackActionWithCallback:(void (^)())p0;
	-(void) onDownloadChangeWithDownloadStatus:(void *)p0;
	-(void) onListenProgressWithProgress:(float)p0;
	-(UIView *) downloadView;
	-(void) setDownloadView:(UIView *)p0;
	-(id) initWithData:(NSData *)p0 downloadStatus:(void *)p1;
@end
