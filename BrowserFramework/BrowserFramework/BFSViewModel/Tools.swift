...
func paramURLAbsoluteString(with absolute: String) -> String {
    ...
    if absolute.contains("http://www.baidu.com/s?wd=") {
        
        result = absolute.replacingOccurrences(of: "http://www.baidu.com/s?wd=", with: "")
    }
    ...
    if absolute.contains("http://www.sogou.com/web?query=") {
        
        result = absolute.replacingOccurrences(of: "http://www.sogou.com/web?query=", with: "")
    }
    ...
    if absolute.contains("http://www.so.com/s?q=") {
        
        result = absolute.replacingOccurrences(of: "http://www.so.com/s?q=", with: "")
    }
