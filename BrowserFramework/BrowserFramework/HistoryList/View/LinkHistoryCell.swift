...
//                    .resizable()
                Image(uiImage: isSelected ? UIImage.bundleImage(name: "ico_checkbox_checked") : UIImage.bundleImage(name: "ico_checkbox_uncheck"))
                    .resizable()
            }
            ...
            Image(uiImage: UIImage.bundleImage(name: "ico_bottomtab_book_normal"))
                .resizable()
