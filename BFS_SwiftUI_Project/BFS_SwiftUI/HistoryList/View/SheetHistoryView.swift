                    ...
                    Section {
                        ForEach(0..<section.items.count, id: \.self) { j in
                            ...
                            if i == viewModel.sections.count - 1, j == section.items.count - 1 {
                                SheetHistoryCell(linkRecord: item, isLast: true, homeConfig: homeConfig, viewModel: viewModel)
                                    .listRowInsets(EdgeInsets(top: 0, leading: 0, bottom: 0, trailing: 0))
                            } else {
                                SheetHistoryCell(linkRecord: item, isLast: j == section.items.count - 1 ? true : false, homeConfig: homeConfig, viewModel: viewModel)
