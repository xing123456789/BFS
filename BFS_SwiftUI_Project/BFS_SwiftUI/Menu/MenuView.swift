...
struct MenuView: View {
        ...
        VStack(spacing: 16) {
            ...
            ForEach(0..<titles.count, id: \.self) { index in
                ...
                .sheet(isPresented: $isShare) {
                    ActivityViewController(urlString: homeConfig.linkString)
                }
            }
    ...
    private func addToBookmark() {
        ...
        guard homeConfig.linkString.count > 0, homeConfig.webTitleString.count > 0 else { return }
        let manager = BookmarkCoreDataManager()
        let bookmark = LinkRecord(link: homeConfig.linkString, imageName: "", title: homeConfig.webTitleString, createdDate: Date().milliStamp)
